...
def followers(request, username):
    ...
    return render(request, 'ramapp/follow_list.html', context)
...
def profile(request, user_username=None):
    ...
    return render(request, 'ramapp/profile.html', context)
...
def edit_info(request):
    ...
    return render(request, "ramapp/edit_info.html", {"form": form})
